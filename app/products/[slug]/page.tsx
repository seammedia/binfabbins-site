...
export default async function ProductDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              <ul className="space-y-3">
                {detail.keyBenefits.map((benefit, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-[#1a2847] mt-0.5 shrink-0" />
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-[#1a2847] text-white">
              ...
              <tbody>
                {detail.dimensions.rows.map((row, i) => (
                  ...
                  >
                    <td className="px-6 py-3 font-semibold text-[#1a2847]">{row.code}</td>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {detail.specifications.map((spec) => (
              ...
              >
                <span className="font-semibold text-[#1a2847]">{spec.label}</span>
      ...
      {/* CTA */}
      <section className="py-16 px-4 bg-[#1a2847] text-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:0478598242"
              className="inline-flex items-center justify-center gap-2 bg-white text-[#1a2847] px-8 py-4 rounded-lg hover:bg-gray-100 transition-colors text-lg font-medium"
            >
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-white hover:text-[#1a2847] transition-colors text-lg font-medium"
            >
              Send an Enquiry
            </Link>
          </div>
